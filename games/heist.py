...
class MuZeroConfig:
    def __init__(self):
        ...
        ### Game
        self.observation_shape = (3, 64, 64)  # Dimensions of the game observation, must be 3D (channel, height, width). For a 1D array, please reshape it to (1, 1, length of array)
        self.action_space = list(range(15))  # Fixed list of all possible actions. You should only edit the length
        ...
        self.lr_decay_rate = 0.05  # Set it to 1 to use a constant learning rate
        self.lr_decay_steps = 350e3

        ### Replay Buffer
        self.replay_buffer_size = int(2e5)  # Number of self-play games to keep in the replay buffer
