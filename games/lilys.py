...
class MuZeroConfig:
    def __init__(self):
        ...
        self.action_space = list(range(117))  # Fixed list of all possible actions. You should only edit the length
        ...
        self.training_steps = int(500000)  # Total number of training steps (ie weights update according to a batch)
